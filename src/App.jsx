  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4] flex flex-col items-center justify-center font-['DM_Sans']">
      <div className="text-center max-w-2xl px-6 -mt-20">
        ...
        <p className="text-xl text-[#666660]">This is Sarah, your virtual assistant! She is here to help. Click the chat icon in the bottom right corner to get started with booking your consultation or answering any questions you may have.</p>
      </div>
      <ChatWidget />
    </div>
  );
